...
if(isset($_POST['delete'])){
   ...
   $message[] = 'barang di keranjang dihapus!';
}
...
if(isset($_POST['delete_all'])){
   ...
   $message[] = 'hapus semua dari keranjang!';
}
...
<div class="heading">
   ...
   <p><a href="home.php">halaman utama</a> <span> / keranjang</span></p>
</div>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <form action="" method="post" class="box">
         ...
         <button type="submit" class="fas fa-times" name="delete" onclick="return confirm('hapus barang ini?');"></button>
         ...
         <div class="sub-total"> total : <span>Rp.<?= $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
      </form>
      <?php
