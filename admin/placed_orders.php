...
<section class="placed-orders">
   ...
   ?>
   <div class="box">
      <p> no pelanggan : <span><?= $fetch_orders['user_id']; ?></span> </p>
      ...
      <p> banyak pesanan : <span><?= $fetch_orders['total_products']; ?></span> </p>
      <p> jumlah harga : <span>$<?= $fetch_orders['total_price']; ?>/-</span> </p>
      <p> metode pembayaran : <span><?= $fetch_orders['method']; ?></span> </p>
      <form action="" method="POST">
         <input type="hidden" name="order_id" value="<?= $fetch_orders['id']; ?>">
         <select name="payment_status" class="drop-down">
            <option value="status" selected disabled><?= $fetch_orders['payment_status']; ?></option>
