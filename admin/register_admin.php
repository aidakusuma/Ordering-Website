...
if(isset($_POST['submit'])){
   ...
   if($select_admin->rowCount() > 0){
      ...
      if($pass != $cpass){
         ...
         $message[] = 'admin baru telah terdaftar!';
      }
   }
...
<section class="form-container">
   ...
   <form action="" method="POST">
      ...
      <input type="password" name="cpass" maxlength="20" required placeholder="konfirmasi password" class="box" oninput="this.value = this.value.replace(/\s/g, '')">
