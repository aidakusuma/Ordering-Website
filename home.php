...
<section class="products">
   ...
   <div class="box-container">
      ...
      <?php
            ...
            echo '<p class="empty">belum ada produk yang dimasukan!</p>';
         }
      ?>
   ...
   <div class="more-btn">
      <a href="menu.html" class="btn">lihat semua</a>
   </div>
